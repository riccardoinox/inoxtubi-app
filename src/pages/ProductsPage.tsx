...
export const ProductsPage: React.FC = () => {
  ...
  const productsList = [
    ...
    {
      title: 'Barre Tonde, Quadre ed Esagonali',
    ...
    {
      title: 'Angolari e Piatti Inox',
      category: 'Angolari',
      standard: 'EN 10088-3 / DIN 1028',
      alloys: ['AISI 304', 'AISI 316L'],
      description: 'Profili angolari a lati uguali laminati a caldo o ricavati da lamiera cesoiata/piegata, e piatti trafilati o cesoiati per carpenteria.',
      finishes: ['Laminato a caldo decapato', 'Trafilato', 'Cesoiato'],
      dimensions: 'Angolari da 20x20x3 a 100x100x10 mm; Piatti da 10x3 a 150x20 mm.'
    },
    {
        ...
        {productsList.map(prod => (
          ...
          >
            <div>
              ...
              {/* Finishes & Dimensions */}
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-[11px] bg-slate-50 p-2.5 rounded-xl border border-slate-200/70 mb-4">
                <div>
